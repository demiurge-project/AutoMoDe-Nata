...
AUTOMODE_BIN_DIR = "/home/aligot/AutoMoDe-Harlequin/bin"
...
def run_automode(mission_file, controller_file, expname, method, resultdir, evaluation_context):
    ...
    output_file = open("/home/aligot/AutoMoDe-Harlequin/evaluation/" + resultdir + "/" + experiment_name + ".txt", 'w')
    seeds = open("/home/aligot/AutoMoDe-Harlequin/evaluation/seeds.txt", 'r').readlines()
