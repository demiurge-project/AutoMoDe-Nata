...
Organism::Organism(double fit, Genome* g, int gen, const char* md) {
    ...
    //Added for repertoires:
    /* vBehavior_char; */
    dNovelty_score = 0;
    dLocal_competition = 0;
    dQuality_score = 0;
...
Organism::Organism(const Organism& org) {
    ...
    // added for repertoires:
    vMed_behavior_char = org.vMed_behavior_char;
    dNovelty_score = org.dNovelty_score;
    dLocal_competition = org.dLocal_competition;
    dQuality_score = org.dQuality_score;
