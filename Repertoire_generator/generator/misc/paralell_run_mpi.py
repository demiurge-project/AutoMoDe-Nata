...
NEAT_DIR = "PATH TO YOUR NEAT/REPERTOIRE INSTALLATION"
...
USERNAME=`whoami`
NEATDIR=%(neatdir)s
COMMAND="$NEATDIR/bin/NEAT-evolution %(experiment)s %(params)s %(startgenes)s %(nbcores)s $NEATDIR/bin/scheduler %(seed)s %(paramsRep)s"
